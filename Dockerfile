...
EXPOSE 8000/tcp
CMD "blockclock-backend" "--port=8000" "--mysql-url=${MYSQL_URL}" "--time-window=${TIME_WINDOW}" "--solver-private-key=${SOLVER_PRIVATE_KEY}" "--ws-chain-url=${WS_CHAIN_URL}" "--tick-period=${TICK_PERIOD}"
